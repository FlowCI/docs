...
![github_setup_deploy_key](../../images/git/github_setup_deploy_key.png)
...
1. Copy webhook url from flow settings
   ...
   ![webhook settings](../../images/git/github_select_webhook_url.png)
...
- Content type
  ...
  ![payload and content](../../images/git/github_setup_payload_and_content.png)
...
- Select events
  ...
  ![events](../../images/git/github_select_events.png)
...
- Deploy Key:
  ...
  ![github_test](../../images/git/github_test_config.gif)